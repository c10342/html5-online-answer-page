var CanvasParticle = (function () {
	...
	function canvasInit(canvasConfig) {
		...
		var body = document.getElementById(canvasConfig.targetId);
		...
		canvasSize(canvas.element, canvasConfig);
	...
	// 设置canvas大小
	function canvasSize(canvas, canvasConfig) {
		// 获取窗口的宽高
		...
		// 获取特定div的宽高
		if (document.getElementById(canvasConfig.targetId)) {
			var width = document.getElementById(canvasConfig.targetId).style.width;
			var height = document.getElementById(canvasConfig.targetId).style.height;
